...
/**
 *  因为到来的数据会按照text格式解析，jQuery需要一种机制能把一种数据类型转换为
 *  另一种数据类型。converters的'text yaml'告诉jQuery，这个转换函数以text格式接收数据，
 *  然后以yaml格式重新解析。
 */
$.ajaxSetup({
  accepts: {
